        ...
        <Detailsbox>
          ...
          <ContactDetails>
            <LocationBox>
              <svg height="20" width="14" xmlns="http://www.w3.org/2000/svg">
                <path
                  ...
                  fill={active ? "#4b6a9b" : "white"}
                />
              </svg>
              <Location>
                {data == false ? "San Francisco" : data?.location}
              </Location>
            </LocationBox>
            <BlogBox>
              <svg height="20" width="20" xmlns="http://www.w3.org/2000/svg">
                <g fill={active ? "#4b6a9b" : "white"}>
              ...
              <Blog>{data == false ? "https://github.blog" : data?.blog}</Blog>
            </BlogBox>
            <TwitterBox>
            ...
            <FirmBox>
              ...
              <Firm>{data == false ? "@github" : data?.company}</Firm>
            </FirmBox>
          </ContactDetails>
        </Detailsbox>
      </CardStyle>
